...
class RedisClient {
	 ...
	 * @param {object} [redisOptions] - Options for redis.createClient and logger.
	 */
	constructor(redisOptions = {}) {
		this.client = createClient(redisOptions);
		this.connected = false;
		this.connecting = false;
		this.logger = new RedisLogger({ client: 'REDIS' });
 ...
 */
export const redisClient = async (redisOptions = {}) => {
